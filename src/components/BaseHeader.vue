<template>
  <v-app-bar elevation="0" color="#42b983" dark class="px-4">
    <v-app-bar-title style="font-weight: 800; color: #fff"> Vue3 Chat App </v-app-bar-title>
    <v-spacer></v-spacer>
    <!-- ログインしている時に表示するコンテンツ -->
    ...
    <!-- ログインしていない時に表示させている -->
    <div v-else>
      <v-btn variant="text" class="mr-1" color="white" href="/signup"> サインアップ </v-btn>
      <v-btn variant="flat" color="white" dark href="/"> ログイン </v-btn>
    </div>
  </v-app-bar>
</template>
